...
var _ generate.ServerInterface = (*PetStore)(nil)

func NewPetStore() *PetStore {
	return &PetStore{
		Pets:   make(map[int64]generate.Pet),
		NextId: 1000,
	}
}
...
func (p *PetStore) FindPets(w http.ResponseWriter, r *http.Request, params generate.FindPetsParams) {
	log.Print("find pets ok")
	p.Lock.Lock()
	defer p.Lock.Unlock()

	var result []generate.Pet
